...
export function PlayerCard({ player, isMvp, isHotStreak, bestPartner, goals, assists, soloGoals, wins, losses, showExpanded = false, rank }: PlayerCardProps) {
...
interface PlayerCardProps {
  ...
  if (showExpanded) {
    return (
      <div className="glass-card-strong p-6 transition-all duration-300 cursor-pointer" onClick={undefined}>
  ...
  return (
    <div
      className="glass-card p-4 cursor-pointer transition-all duration-200 hover:scale-105 hover:shadow-xl"
      onClick={typeof showExpanded === 'boolean' ? undefined : undefined}
    >
